        ...
        },
        {
          ...
          answer: (
            <div>
              ...
              <p className="ml-14 mt-1"> <span style={{ color: "blue" }}> राशियाँ  दो प्रकार के होते हैं: </span></p>
              <ul className="ml-14 mt-1">
                <li> (i) अदिश राशियाँ  (जैसे द्रव्यमान, तापमान, समय, घनत्व आदि)</li>
                <li> (ii) सदिश राशियाँ (जैसे बल, वेग, त्वरण आदि)</li>
              </ul>
            </div>
          ),
        },
    ...
    return (
      <div className="p-4">
        ...
        <div className='flex justify-between'>
          <div>
        <Image src={"/image/8th-S-Chap-12.png"} className=' rounded mb-12 transition-all transform hover:animate-shake' width={2500} height={300} alt='img'></Image>
        </div>
