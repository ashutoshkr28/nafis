                ...
                return (
                  <div className="p-4">
                    ...
                    <div className='flex justify-between'>
                      <div>
                    <Image src={"/image/9th-chemistry-subjective-chapter-5.png"} className=' rounded mb-12 transition-all transform hover:animate-shake' width={2500} height={300} alt='img'></Image>
                    </div>
