...

        {
          ...
          answer: (
            <div>
              ...
              <ul className="ml-12 list-decimal">
                <li><b style={{ color: "red" }} >मिट्टी की तैयारी:</b> मिट्टी की जाँच करें और उसमें आवश्यक पोषक तत्व मिलाएं। <br /><b style={{ color: "aqua" }} > (उदाहरण: गोबर की खाद)</b> </li>
                <li><b style={{ color: "red" }} >बीज का चयन:</b> अच्छी गुणवत्ता वाले बीज का चयन करें। <br /><b style={{ color: "aqua" }} > (उदाहरण: हाइब्रिड बीज)</b></li>
                <li><b style={{ color: "red" }} >सिंचाई:</b> पौधों को आवश्यक पानी दें। <br /> <b style={{ color: "aqua" }} >  (उदाहरण: ड्रिप सिंचाई) </b></li>
                <li><b style={{ color: "red" }} >उर्वरकों का उपयोग:</b> अच्छी गुणवत्ता वाले उर्वरकों का उपयोग करें। <br /><b style={{ color: "aqua" }} > (उदाहरण: यूरिया) </b></li>
                <li><b style={{ color: "red" }} >कीट और रोग नियंत्रण:</b> कीट और रोग की पहचान करें और उनके नियंत्रण के लिए आवश्यक कदम उठाएं। <br /><b style={{ color: "aqua" }} > (उदाहरण: कीटनाशकों का उपयोग)</b></li>
                <li><b style={{ color: "red" }} >फसल की देखभाल:</b> फसल की नियमित जाँच करें और उसकी आवश्यकताओं को पूरा करें। <br /><b style={{ color: "aqua" }} > (उदाहरण: फसल की पत्तियों की जाँच)</b></li>
              </ul>
            </div>
          ),
        },
