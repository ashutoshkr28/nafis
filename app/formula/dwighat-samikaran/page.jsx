    ...
    <div className="bg-gray-100 px-4 py-8 sm:px-8 sm:py-12 lg:px-16">
      ...
      <div className="space-y-6">
        <div className="bg-white shadow p-4 sm:p-6 rounded hover:scale-105 transition duration-300 ease-in-out">
          <span className="text-2xl sm:text-3xl">द्विघात समीकरण का व्यापक रूप:</span>{" "}
          <p className="text-2xl sm:text-2xl mt-2">
            <InlineMath math="ax^2 + bx + c = 0" />
          </p>
        </div>

        <div className="bg-white shadow p-4 sm:p-6 rounded hover:scale-105 transition duration-300 ease-in-out">
          <span className="text-2xl sm:text-3xl">विविक्तकर (विवेचक): </span>{" "}
          <span className="text-2xl sm:text-3xl mt-2">
            <InlineMath math="D = b^2 - 4ac" />
          </span>
        </div>

        <div className="bg-white shadow p-4 sm:p-6 rounded hover:scale-105 transition duration-300 ease-in-out">
          <span className="text-2xl sm:text-3xl">द्विघात सूत्र:</span>{" "}
        ...
        <div className="bg-white shadow p-4 sm:p-6 rounded hover:scale-105 transition duration-300 ease-in-out">
          <span className="text-2xl sm:text-3xl">जब D = 0,</span>{" "}
          <span className="text-2xl sm:text-3xl mt-2">तब मूल वास्तविक और समान होंगे।</span>
        </div>

        <div className="bg-white shadow p-4 sm:p-6 rounded hover:scale-105 transition duration-300 ease-in-out">
          <span className="text-2xl sm:text-3xl">जब D &gt; 0,</span>{" "}
          <span className="text-2xl sm:text-3xl mt-2">तब मूल वास्तविक और असमान होंगे।</span>
        </div>

        <div className="bg-white shadow p-4 sm:p-6 rounded hover:scale-105 transition duration-300 ease-in-out">
          <span className="text-2xl sm:text-3xl">जब D &lt; 0, </span>{" "}
          <span className="text-2xl sm:text-3xl mt-2">तब मूल वास्तविक नहीं होंगे।</span>
        </div>

        <div className="bg-white shadow p-4 sm:p-6 rounded hover:scale-105 transition duration-300 ease-in-out">
          <span className="text-2xl sm:text-3xl">मूलों का योग: (α + β) =</span>{" "}
          <span className="text-2xl sm:text-3xl mt-2">
            <InlineMath math="-\frac{b}{a}" />
          </span>
        </div>
        ...
        <div className="bg-white shadow p-4 sm:p-6 rounded hover:scale-105 transition duration-300 ease-in-out">
          <span className="text-2xl sm:text-3xl">मूलों का गुणनफल: (α × β) =</span>{""}
          <span className="text-2xl sm:text-3xl mt-2">
            <InlineMath math="\frac{c}{a}" />
          </span>
        </div>
