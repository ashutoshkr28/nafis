            ...
            {chapters.map((chapter, index) => (
              <tr key={index} className="hover:bg-gray-100 transition duration-150">
                <td className="px-4 py-2 border text-2xl text-left border-gray-300">
                  ...
                  <Link
                    href={`/objective/english/${chapter.slug}/[chapter]`} // Add chapter specific URL part
                    as={`/objective/english/${chapter.slug}/chapter1`} // Example, you will adjust to fetch the correct chapter dynamically
