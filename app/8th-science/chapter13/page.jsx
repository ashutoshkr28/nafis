...
//       questions: [
        ...
        },
        {
          ...
          answer: (
            <div>
              <b style={{ color: "green" }}>उत्तर:—</b><br /> <span style={{ color: "blue" }} className="ml-16">मानव कान की बाहरी बनावट में तीन मुख्य भाग होते हैं:</span>
              <ul className="ml-16">
              ...
              <span style={{ color: "blue" }} className="ml-16">आंतरिक बनावट में तीन मुख्य भाग होते हैं:</span>
              <ul className="ml-16">
    ...
    return (
      <div className="p-4">
        ...
        <div className='flex justify-between'>
          <div>
        <Image src={"/image/8th-S-Chap-13.png"} className=' rounded mb-12 transition-all transform hover:animate-shake' width={2500} height={300} alt='img'></Image>
        </div>
