...
//           <p className="text-lg md:text-xl text-gray-600">Hello! i'm Nafis Sir, a passionate Mathematics teacher dedicated to inspiring and guiding student to achieve excellence in maths.</p>

//           <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">My Mission</h1>
//           <p>My goal to make Mathematics accessible, enjoyable, and rewarding for all students. I strive to create a supportive learning environment that fosters curiosity, creativity, and critical thinking.</p>

//           <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">Teaching Experience</h1>
//           <p>I have been teaching Mathematics and Science at Neha Challemge Coaching Center Chhaurahi for 7 year helping students from to succeed in their academic pursuits.</p>
//           <h1 className="text-2xl md:text-3xl font-bold text-gray-800 mb-2">My Approach</h1>
//           <ul>
//             <li>Student-centered learning</li>
//             <li>Interactive and engaging teaching methods</li>
//             <li>Emphasis on problem=solving and real-world applications</li>
...
const Page = () => {
  return (
    <footer className="bg-gray-50">
      ...
      <section className="bg-white py-12 md:py-16 shadow-sm">
        <div className="max-w-6xl mx-auto px-6 text-center md:text-left">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-gray-600">
                My goal is to make Mathematics accessible, enjoyable, and 
                rewarding for all students. I aim to create a supportive 
                learning environment that fosters curiosity, creativity, and 
                critical thinking.
              </p>
            </div>
            <div>
              <h2 className="text-2xl font-bold text-gray-800 mb-4">Teaching Experience</h2>
              <p className="text-gray-600">
                I have been teaching Mathematics and Science at Neha Challenge 
                Coaching Center, Chhaurahi, for 7 years, helping students 
          ...
          <div className="mt-12">
            <h2 className="text-2xl font-bold text-gray-800 mb-4">My Approach</h2>
      ...
      <section className="bg-gray-100 py-12 md:py-16">
        <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center md:items-start md:justify-between gap-12">
          {/* Left: Managed By */}
          <div className="text-center md:text-left">
            <h2 className="text-3xl font-bold text-gray-800 mb-6">Managed By</h2>
            <Image
              src={assets.abtimg}
              width={120}
              height={120}
              alt="Managed by Nafis"
              className="rounded-full mx-auto md:mx-0 mb-6 border-4 border-indigo-500"
            />
            ...
            <p className="text-gray-600">
              <a href="tel:+918877241912" className="hover:underline">
                Phone: +91 8877241912
              </a>
            </p>
          </div>
            ...
            <div className="flex space-x-6 justify-center md:justify-start">
              ...
              >
                <svg
                  ...
                  viewBox="0 0 24 24"
                >
                  <path d="M12 2.163c3.204 0 3.584.012 4.85.07 1.366.062 2.633.337 3.608 1.312.975.975 1.25 2.242 1.312 3.608.058 1.266.07 1.646.07 4.85s-.012 3.584-.07 4.85c-.062 1.366-.337 2.633-1.312 3.608-.975.975-2.242 1.25-3.608 1.312-1.266.058-1.646.07-4.85.07s-3.584-.012-4.85-.07c-1.366-.062-2.633-.337-3.608-1.312-.975-.975-1.25-2.242-1.312-3.608-.058-1.266-.07-1.646-.07-4.85s.012-3.584.07-4.85c.062-1.366.337-2.633 1.312-3.608.975-.975 2.242-1.25 3.608-1.312 1.266-.058 1.646-.07 4.85-.07z" />
                </svg>
              </a>
            </div>
          </div>
