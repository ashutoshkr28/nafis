...
const questions = [
    ...
    },
    {
      ...
      answer: (
        <div>
          <b style={{ color: "green" }}>उत्तर:—</b> पदार्थ तीन प्रकार के होते हैं:
          <ul>
            <li>
              <b style={{color: "blue"}}>ठोस:</b> वैसे पदार्थ जिसकी आकृति और आयतन दोनों निश्चित होते हैं।
              <b style={{color: "violet"}}>जैसे:</b> ईंट, पत्थर, लकड़ी, बोर्ड।
            </li>
            <li>
              <b style={{color: "blue"}}>द्रव:</b> वैसे पदार्थ जिसकी आकृति अनिश्चित लेकिन आयतन निश्चित
              होता है। <b style={{color: "violet"}}>जैसे:</b> पानी, डीजल, दूध।
            </li>
            <li>
              <b style={{color: "blue"}}>गैस:</b> वैसे पदार्थ जिसकी आकृति और आयतन दोनों अनिश्चित होते हैं।
              <b style={{color: "violet"}}>जैसे:</b> ऑक्सीजन, नाइट्रोजन, कार्बन डाइऑक्साइड।
            </li>
          </ul>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div>
          <b style={{ color: "green" }}>उत्तर:—</b> ठोस पदार्थ के सामान्य गुण निम्न हैं:
          <ul>
    ...
    },
    {
      ...
      answer: (
        <div>
          <b style={{ color: "green" }}>उत्तर:—</b> द्रव पदार्थ के सामान्य गुण:
          <ul>
    ...
    },
    {
      ...
      answer: (
        <div>
          <b style={{ color: "green" }}>उत्तर:—</b> गैस पदार्थ के सामान्य गुण:
          <ul>
    ...
    },
    {
      ...
      answer: (
        <div>
          <b style={{ color: "green" }}>उत्तर:—</b> वाष्पन को प्रभावित करने वाले
          कारण निम्न हैं:
          <ul>
    ...
    },
    {
    ...
    },
      {
        ...
        answer: (
          <div>
            ...
            <ul>
              <li>द्रव का क्वथनांक 100⁰ C होता है।</li>
              <li>अगर पानी में नमक मिला दिया जाए तो पानी का क्वथनांक 100⁰ C से अधिक होता है।</li>
              <li>अगर पानी में चीनी मिला दिया जाए तो पानी का क्वथनांक 100⁰ C से अधिक होता है।</li>
            </ul>
          </div>
        ),
      },
      {
        ...
        answer: (
          <div>
            <b style={{ color: "green" }}>उत्तर:—</b> वाष्पन और क्वथन में निम्न अंतर है:
            <ul>
              <li>
                <b style={{color: "blue"}}>वाष्पन:</b>
                <ul>
      ...
      },
      {
        ...
        answer: (
          <div>
            <b style={{ color: "green" }}>उत्तर:—</b> पदार्थ की तीन अवस्थाएँ होती हैं:
            ठोस, द्रव, गैस। <br />
            पदार्थ की अवस्थाओं में परिवर्तन निम्नलिखित हैं:
            <ul>
              <li>
                <b style={{color: "blue"}}>ठोस से तरल में परिवर्तन:</b> जब ठोस पदार्थ को गर्म किया जाता है,
              ...
              <li>
                <b style={{color: "blue"}}>तरल से गैस में परिवर्तन:</b> जब तरल पदार्थ को गर्म किया जाता है,
              ...
              <li>
                <b style={{color: "blue"}}>गैस से तरल में परिवर्तन:</b> जब गैस को ठंडा किया जाता है, तो वह
              ...
              <li>
                <b style={{color: "blue"}}>तरल से ठोस में परिवर्तन:</b> जब तरल पदार्थ को ठंडा किया जाता है,
              ...
              <li>
                <b style={{color: "blue"}}>ठोस से गैस में परिवर्तन:</b> जब ठोस पदार्थ को गर्म किया जाता है,
      ...
      },
        {
          ...
          answer: (
            <div>
              <b style={{ color: "green" }}>उत्तर:—</b> ठोस द्रव और गैस में निम्न अंतर है।
              <ul>
                <li>
                  <b style={{color: "blue"}}>ठोस:</b>
                  <ul>
