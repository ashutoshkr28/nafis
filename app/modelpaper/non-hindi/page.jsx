...
const UserDownloads = () => {
  const pdfFiles = [
    ...
    { name: "Non-Hindi 2021", file: "/uploads/english.pdf", image: "/image/Bihar-Board-Class-10th-Non-Hindi-Model-Paper-2021.png" },
    { name: "Non-Hindi 2020", file: "/uploads/english.pdf", image: "/image/Bihar-Board-Class-10th-Non-Hindi-Model-Paper-2020.png" },
  ];
