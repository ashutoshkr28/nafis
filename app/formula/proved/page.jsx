...
const ProofPage = () => {
  return (
    ...
    <InlineMath>{'{\\therefore \\sqrt{2} \\text{ एक परिमेय  संख्या नहीं  है।}}'}</InlineMath>
      ...
      <div className="border border-gray-400 shadow p-2 text-xl -mx-4">
        ...
        <p className=" mb-4 text-xl text-left sm:text-4xl sm:text-center">
          <span className="font-semibold text-green-700 ">उत्तर:</span> 
        ...
        <p className="mb-2 text-xl sm:text-4xl">
          p<sup>2</sup> = 5q<sup>2</sup>  ...............(i)   </p>
         <p className='mt-2 sm:text-4xl'>  p = विषम संख्या है। </p>
         <p className='mt-2 sm:text-4xl'>∵ विषम संख्या का वर्ग विषम ही होता है। </p>
          <p className='mt-2 sm:text-4xl'>  माना कि p = 5m</p>
        
        <p className="mb-2 mt-2 text-xl sm:text-4xl">
          समीकरण (i) से, </p>
        ...
        <p className="mt-2 text-xl border border-blue-600 text-blue-600 p-2 sm:text-4xl">
  ...
  <p className="text-xl mt-2 border border-blue-600 text-blue-600 p-2 sm:text-4xl">
...
<div className="border border-gray-400 shadow p-2 text-xl -mx-4">
  <p className="mb-4 text-red-600 text-xl font-bold text-left sm:text-center mt-4 sm:text-4xl">
  ...
  <p className="mb-4 text-xl sm:text-4xl">
   ...
   <p className="mb-4 text-xl mt-2 sm:text-4xl">समीकरण (i) से, </p>
   ...
   <p className='mt-2 sm:text-4xl'>13m<sup>2</sup> = q<sup>2</sup>
    ...
    <p className="mt-2 text-xl sm:text-4xl">q = विषम संख्या है। </p>
  ...
  <p className="text-xl mt-2 border border-blue-600 text-blue-600 p-3 sm:text-4xl">
...
<div className="border border-gray-400 shadow p-2 text-xl -mx-4">
  ...
  <p className="mb-4 text-xl text-left sm:text-center mt-2 sm:text-4xl">
    <span className="font-semibold text-green-700">उत्तर:</span> 
  ...
  <p className="mb-4 text-xl mt-2 sm:text-4xl">
...
<div className="border border-purple-500 p-2 shadow text-xl -mx-4">
  ...
  <p className="mb-4 text-xl text-left sm:text-center sm:text-4xl">
   ...
   <p className='mt-2 sm:text-4xl'> अपरिमेय संख्या = परिमेय संख्या (जो कि संभव नहीं है)। </p>
   <p className='mt-2 sm:text-4xl'> अतः हमारी मान्यता गलत है। </p>
  
  <p className="mb-4 text-xl mt-2 sm:text-4xl">
    <InlineMath>{'\\therefore \\frac{1}{\\sqrt{2}}'}</InlineMath> एक परिमेय संख्या नहीं है। </p>
    <p className='border border-blue-600 text-blue-600 p-3 sm:text-4xl'><InlineMath>{'\\boxed{\\therefore \\frac{1}{\\sqrt{2}} \\text{ एक अपरिमेय संख्या है।}}'}</InlineMath>
  </p>
  <p className="mt-4 text-violet-600 font-bold text-2xl mb-4">Proved</p>
</div>
...
<div className="border border-purple-500 p-2 shadow text-xl -mx-4">
  ...
  <p className="mb-4 text-xl mt-2 sm:text-4xl">
   ...
   <p className='border border-blue-600 text-blue-600 p-3 sm:text-4xl'> <InlineMath>{'\\boxed{\\therefore \\frac{1}{\\sqrt{3}} \\text{ एक अपरिमेय संख्या है।}}'}</InlineMath>
  </p>
  <p className="mt-4 text-violet-600 font-bold text-2xl mb-4">Proved</p>
</div>
...
<div className="border border-purple-500 p-2 shadow text-xl -mx-4">
  ...
  <p className="mb-4 text-xl mt-2 sm:text-4xl">
   ...
   <p className='sm:text-4xl'> <InlineMath math={'\\boxed{\\therefore 3 - \\sqrt{2} \\text{ एक अपरिमेय संख्या है।}}'} />
  </p>
  <p className="mt-4 text-violet-600 font-bold text-2xl mb-4">Proved</p>
</div>
...
<div className="border border-purple-500 p-2 shadow text-xl -mx-4">
  ...
  <p className="mb-4 text-xl mt-2 sm:text-4xl">
    ...
    <p className='mt-2 sm:text-4xl border border-blue-600 text-blue-600 p-3'><InlineMath math={'\\boxed{\\therefore 5 - \\sqrt{3} \\text{ एक अपरिमेय संख्या है।}}'} />
  </p>
  <p className="mt-4 text-violet-600 font-bold text-2xl mb-4">Proved</p>
</div>
...
<div className="border border-purple-500 p-2 shadow text-xl -mx-4  ">
  ...
  <p className="mb-4 text-xl mt-2 sm:text-4xl">
   ...
   <p className='mt-2 border border-blue-600 text-blue-600 p-3   sm:text-4xl'> <InlineMath math={'\\boxed{\\therefore 3 + 2\\sqrt{5} \\text{ एक अपरिमेय संख्या है।}}'} /> </p>
