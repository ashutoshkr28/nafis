    ...
    },
    {
      ...
      answer: (
        <div>
          ...
          <ul>
            <li><b>भौतिक विज्ञान:</b> इसमें हम निर्जीव पदार्थों और उनसे संबंधित घटनाओं के बारे में अध्ययन करते हैं।</li>
            <li><b>जीव विज्ञान:</b> इसमें हम सजीव पदार्थों और उनसे संबंधित घटनाओं के बारे में अध्ययन करते हैं।</li>
          </ul>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div>
          ...
          <ul>
            <li><b>भौतिक Physics</b></li>
            <li><b>रसायन शास्त्र Chemistry</b></li>
          </ul>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div>
          ...
          <ul>
            <li><b>वनस्पति विज्ञान Botany</b></li>
            <li><b>प्राणी विज्ञान Zoology</b></li>
          </ul>
        </div>
      ),
    },
    ...
    },
    {
      ...
      answer: (
        <div>
          ...
          <ul>
            <li><b>मात्रक:</b> जिसमें राशि को व्यक्त किया जाता है।</li>
            <li><b>संख्यांक:</b> जो बताता है कि दी गई राशि कितना है।</li>
          </ul>
          जैसे:— 5 मीटर लंबाई का परिमाण।
          <p>इसमें (5) संख्यांक और (मीटर) मात्रक है।</p>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div>
          ...
          <br />
          जैसे:— लंबाई, द्रव्यमान, क्षेत्रफल, आयतन, ऊर्जा इत्यादि।
        </div>
      ),
    },
    {
      ...
      answer: (
        <div>
          ...
          <ul>
            <li><b>आधारी राशि</b></li>
            <li><b>व्युत्पन्न राशि</b></li>
          </ul>
        </div>
      ),
    },
    ...
    },
    {
      ...
      answer: (
        <div>
          ...
          <ul>
            <li><b>फुट–पाउंड–सेकंड पद्धति (FPS)</b>:— इस पद्धति में लंबाई को फुट में, द्रव्यमान को पाउंड में और समय को सेकंड में मापा जाता है।</li>
            <li><b>सेंटीमीटर–ग्राम–सेकंड पद्धति (CGS)</b>:— इस पद्धति में लंबाई को सेंटीमीटर में, द्रव्यमान को ग्राम में और समय को सेकंड में मापा जाता है।</li>
            <li><b>मीटर–किलोग्राम–सेकंड पद्धति (MKS)</b>:— इस पद्धति में लंबाई को मीटर में, द्रव्यमान को किलोग्राम में और समय को सेकंड में मापा जाता है।</li>
            <li><b>अंतर्राष्ट्रीय पद्धति (S.I)</b>:— वह मात्रक जो सभी देशों के लिए एक ही है।</li>
          </ul>
        </div>
      ),
    },
    {
      ...
      answer: (
        <div>
          ...
          <ul>
            <li><b>लंबाई:</b> मीटर (M)</li>
            <li><b>द्रव्यमान:</b> किलोग्राम (Kg)</li>
            <li><b>समय:</b> सेकंड (S)</li>
            <li><b>विद्युत धारा:</b> एम्पीयर (A)</li>
            <li><b>ताप या तापमान:</b> केल्विन (K)</li>
            <li><b>ज्योति तीव्रता:</b> कैंडेला (Cd)</li>
            <li><b>पदार्थ का परिमाण:</b> मोल (Mol)</li>
          </ul>
        </div>
      ),
    },
    ...
    },
    {
      ...
      answer: (
        <div>
          ...
          <ul>
            <li><b>समतल कोण:</b> दो रेखाओं से बने कोण को समतल कोण कहते हैं। इसका S.I मात्रक <b>रेडियन (rad)</b> है।</li>
            <li><b>घन कोण:</b> तीन रेखाओं से बने कोण को घन कोण कहते हैं। इसका S.I मात्रक <b>स्टेरेडियन (sr)</b> है।</li>
          </ul>
